...
def get_db():
    ...
    try:
        ...
        raise http_exc # Relanza el error HTTP

    except exc.SQLAlchemyError as e:
        # Atrapa cualquier error de la base de datos (conexión, integridad, etc.)
        db.rollback()
        ...
        raise HTTPException(status_code=500, detail="Error interno de base de datos.")
         ...
         # Atrapa cualquier otro bug inesperado (ej. NameError, TypeError en nuestro código)
         db.rollback() 
